...
class ModelData(object):
    MODEL_PATH = "facenet_ccna_inc_resnet_v1.caffemodel"
    DEPLOY_PATH = "facenet_test_clobotics.prototxt"
    INPUT_SHAPE = (3, 256, 256)
    OUTPUT_NAME = "normed_features"
...
def main():
    ...
    data_path, data_files = common.find_sample_data(description="Runs a Facenet network with a TensorRT inference engine.", subfolder="facenet_test_data", find_files=["binoculars.jpeg", "reflex_camera.jpeg", "tabby_tiger_cat.jpg", ModelData.MODEL_PATH, ModelData.DEPLOY_PATH, "class_labels.txt"])
