#script to convert facenet tensorflow definition into caffe deploy prototxt
import caffe
...
def factorization_conv_mxn_scale(bottom, num_output=64, kernel_h=1, kernel_w=7, stride=1, pad_h=3, pad_w=0):
    ...
    return conv_mxn, conv_mxn_bn,  conv_mxn_relu
...
def stem_v4_299x299(bottom):
    ...
    conv4_1x1_s1, conv4_1x1_s1_bn,  conv4_1x1_s1_relu = \
        factorization_conv_bn_relu_phase(inception_stem1_pool, num_output=80, kernel_size=1, stride = 1) # 80x38x38
    conv5_3x3_s1, conv5_3x3_s1_bn,  conv5_3x3_s1_relu = \
        factorization_conv_bn_relu_phase(conv4_1x1_s1, num_output=192, kernel_size=3, stride=1) # 192x36x36
    conv6_3x3_s2, conv6_3x3_s2_bn,  conv6_3x3_s2_relu = \
        factorization_conv_bn_relu_phase(conv5_3x3_s1, num_output=256, kernel_size=3, stride=2) # 256x17x17
    

    return conv1_3x3_s2, conv1_3x3_s2_bn,  conv1_3x3_s2_relu, conv2_3x3_s1, conv2_3x3_s1_bn, \
            conv2_3x3_s1_relu, conv3_3x3_s1, conv3_3x3_s1_bn,  conv3_3x3_s1_relu, \
           inception_stem1_pool, conv4_1x1_s1, conv4_1x1_s1_bn,  conv4_1x1_s1_relu, \
           conv5_3x3_s1, conv5_3x3_s1_bn,  conv5_3x3_s1_relu, \
           conv6_3x3_s2, conv6_3x3_s2_bn,  conv6_3x3_s2_relu
...
def inception_v4_a(bottom, n = 256):
    ...
    conv_1x1_b0, conv_1x1_b0_bn,  conv_1x1_b0_relu = \
        factorization_conv_bn_relu_phase(bottom, num_output=32, kernel_size=1)  # 32x17x17

    conv_1x1_b1, conv_1x1_b1_bn,  conv_1x1_b1_relu = \
        factorization_conv_bn_relu_phase(bottom, num_output=32, kernel_size=1)  # 32x17x17
    conv_3x3_b1, conv_3x3_b1_bn,  conv_3x3_b1_relu = \
        factorization_conv_bn_relu_phase(conv_1x1_b1, num_output=32, kernel_size=3, pad=1)  # 32x17x17

    conv_1x1_b2, conv_1x1_b2_bn,  conv_1x1_b2_relu = \
        factorization_conv_bn_relu_phase(bottom, num_output=32, kernel_size=1)  # 32x17x17
    conv_3x3_b2, conv_3x3_b2_bn,  conv_3x3_b2_relu = \
        factorization_conv_bn_relu_phase(conv_1x1_b2, num_output=32, kernel_size=3, pad=1)  # 32x17x17
    conv_3x3_b2_a, conv_3x3_b2_a_bn,  conv_3x3_b2_a_relu = \
    ...
    return conv_1x1_b0, conv_1x1_b0_bn,  conv_1x1_b0_relu, \
           conv_1x1_b1, conv_1x1_b1_bn,  conv_1x1_b1_relu, \
           conv_3x3_b1, conv_3x3_b1_bn,  conv_3x3_b1_relu, \
           conv_1x1_b2, conv_1x1_b2_bn,  conv_1x1_b2_relu, \
           conv_3x3_b2, conv_3x3_b2_bn,  conv_3x3_b2_relu, \
...
def reduction_v4_a(bottom, k=192, l=192, m=256, n=384):
    ...
    conv_3x3, conv_3x3_bn,  conv_3x3_relu = \
        factorization_conv_bn_relu_phase(bottom, num_output=n, kernel_size=3, stride=2)  # 384x8x8

    conv_1x1_reduce, conv_1x1_reduce_bn,  conv_1x1_reduce_relu = \
    ...
    conv_3x3_3, conv_3x3_3_bn,  conv_3x3_3_relu = \
    ...
    return conv_3x3, conv_3x3_bn,  conv_3x3_relu, \
           conv_1x1_reduce, conv_1x1_reduce_bn,  conv_1x1_reduce_relu, \
           conv_3x3_2, conv_3x3_2_bn,  conv_3x3_2_relu, \
           conv_3x3_3, conv_3x3_3_bn,  conv_3x3_3_relu, pool, concat
...
def inception_v4_b(bottom, n = 896):
    ...
    conv_1x7_2_reduce, conv_1x7_2_reduce_bn,  conv_1x7_2_reduce_relu = \
        factorization_conv_bn_relu_phase(bottom, num_output=128, kernel_size=1)  # 128x8x8
    conv_1x7_2, conv_1x7_2_bn,  conv_1x7_2_relu = \
        factorization_conv_mxn(conv_1x7_2_reduce, num_output=128, kernel_h=1, kernel_w=7, pad_h=0, pad_w=3)  # 128x8x8
    conv_7x1_2, conv_7x1_2_bn,  conv_7x1_2_relu = \
    ...
    return conv_1x1, conv_1x1_bn,  conv_1x1_relu, \
           conv_1x7_2_reduce, conv_1x7_2_reduce_bn,  conv_1x7_2_reduce_relu, conv_1x7_2, \
           conv_1x7_2_bn,  conv_1x7_2_relu, conv_7x1_2, conv_7x1_2_bn,  \
...
def reduction_v4_b(bottom):
    ...
    conv_3x3_reduce_1, conv_3x3_reduce_1_bn,  conv_3x3_reduce_1_relu = \
        factorization_conv_bn_relu_phase(bottom, num_output=256, kernel_size=1)  # 256x8x8
    ...
    conv_3x3_reduce_2, conv_3x3_reduce_2_bn,  conv_3x3_reduce_2_relu = \
        factorization_conv_bn_relu_phase(bottom, num_output=256, kernel_size=1)  # 256x8x8
    conv_3x3_2, conv_3x3_2_bn,  conv_3x3_2_relu = \
        factorization_conv_bn_relu_phase(conv_3x3_reduce_2, num_output=256, kernel_size=3, stride=1, pad = 1)  # 256x8x8
    conv_3x3_2a, conv_3x3_2a_bn,  conv_3x3_2a_relu = \
    ...
    return conv_1x1_reduce, pool, conv_3x3_reduce, conv_3x3_reduce_bn,  conv_3x3_reduce_relu, \
           conv_3x3, conv_3x3_bn,  conv_3x3_relu, \
           conv_3x3_reduce_1, conv_3x3_reduce_1_bn,  conv_3x3_reduce_1_relu, \
           conv_3x3_1, conv_3x3_1_bn,  conv_3x3_1_relu, \
           conv_3x3_reduce_2, conv_3x3_reduce_2_bn,  conv_3x3_reduce_2_relu, \
           conv_3x3_2, conv_3x3_2_bn,  conv_3x3_2_relu, \
           conv_3x3_2a, conv_3x3_2a_bn,  conv_3x3_2a_relu, concat
...
def inception_v4_c(bottom, n = 1792, scale = 0.20, activation = True):
    ...
    conv_1x1_2, conv_1x1_2_bn,  conv_1x1_2_relu = \
        factorization_conv_bn_relu_phase(bottom, num_output=192, kernel_size=1)  # 192x3x3
    conv_1x3_2, conv_1x3_2_bn,  conv_1x3_2_relu = \
        factorization_conv_mxn(conv_1x1_2, num_output=192, kernel_h=1, kernel_w=3, pad_h=0, pad_w=1)  # 192x3x3
    conv_3x1_2, conv_3x1_2_bn,  conv_3x1_2_relu = \
    ...
    if activation:
        output_relu = L.ReLU(output, in_place=True)
        return conv_1x1, conv_1x1_bn,  conv_1x1_relu, conv_1x1_2, conv_1x1_2_bn,  conv_1x1_2_relu, conv_1x3_2, conv_1x3_2_bn,  conv_1x3_2_relu, conv_3x1_2, conv_3x1_2_bn,  conv_3x1_2_relu, concat, conv_1x1_3, scaled, output, output_relu
    else:
        return conv_1x1, conv_1x1_bn,  conv_1x1_relu, conv_1x1_2, conv_1x1_2_bn,  conv_1x1_2_relu, conv_1x3_2, conv_1x3_2_bn,  conv_1x3_2_relu, conv_3x1_2, conv_3x1_2_bn,  conv_3x1_2_relu, concat, conv_1x1_3, scaled, output
        

string_a = 'n.inception_a(order)_1x1_b0, n.inception_a(order)_1x1_b0_bn,  n.inception_a(order)_1x1_b0_relu, \
           n.inception_a(order)_1x1_b1, n.inception_a(order)_1x1_b1_bn,  n.inception_a(order)_1x1_b1_relu, \
           n.inception_a(order)_3x3_b1, n.inception_a(order)_3x3_b1_bn,  n.inception_a(order)_3x3_b1_relu, \
           n.inception_a(order)_1x1_b2, n.inception_a(order)_1x1_b2_bn,  n.inception_a(order)_1x1_b2_relu, \
           n.inception_a(order)_3x3_b2, n.inception_a(order)_3x3_b2_bn,  n.inception_a(order)_3x3_b2_relu, \
           n.inception_a(order)_3x3_b2_a, n.inception_a(order)_3x3_b2_a_bn,  n.inception_a(order)_3x3_b2_a_relu, \
...
string_b = 'n.inception_b(order)_1x1, n.inception_b(order)_1x1_bn,  n.inception_b(order)_1x1_relu, \
           n.inception_b(order)_1x7_2_reduce, n.inception_b(order)_1x7_2_reduce_bn,  n.inception_b(order)_1x7_2_reduce_relu, n.inception_b(order)_1x7_2, \
           n.inception_b(order)_1x7_2_bn,  n.inception_b(order)_1x7_2_relu, n.inception_b(order)_7x1_2, n.inception_b(order)_7x1_2_bn,  \
...
string_c = 'n.inception_c(order)_1x1, n.inception_c(order)_1x1_bn,  n.inception_c(order)_1x1_relu, \
           n.inception_c(order)_1x1_2, n.inception_c(order)_1x1_2_bn,  n.inception_c(order)_1x1_2_relu, \
           n.inception_c(order)_1x3_2, n.inception_c(order)_1x3_2_bn,  n.inception_c(order)_1x3_2_relu, \
           n.inception_c(order)_3x1_2, n.inception_c(order)_3x1_2_bn,  n.inception_c(order)_3x1_2_relu, \
...
class InceptionV4(object):
    ...
    def inception_v4_proto(self, batch_size, phase='TRAIN'):
        n = caffe.NetSpec()
        n.data = L.Input(name = 'data', shape=dict(dim=[1,3,256,256]))
        ...
        n.conv1_3x3_s2, n.conv1_3x3_s2_bn,  n.conv1_3x3_s2_relu, n.conv2_3x3_s1, n.conv2_3x3_s1_bn, \
            n.conv2_3x3_s1_relu, n.conv3_3x3_s1, n.conv3_3x3_s1_bn,  n.conv3_3x3_s1_relu, \
           n.inception_stem1_pool, n.conv4_1x1_s1, n.conv4_1x1_s1_bn,  n.conv4_1x1_s1_relu, \
           n.conv5_3x3_s1, n.conv5_3x3_s1_bn,  n.conv5_3x3_s1_relu, \
           n.conv6_3x3_s2, n.conv6_3x3_s2_bn,  n.conv6_3x3_s2_relu = \
        ...
        # reduction_v4_a
        n.reduction_a_conv_3x3, n.reduction_a_conv_3x3_bn,  n.reduction_a_conv_3x3_relu, \
        n.reduction_a_conv_1x1_reduce, n.reduction_a_conv_1x1_reduce_bn,  n.reduction_a_conv_1x1_reduce_relu, \
        n.reduction_a_conv_3x3_2, n.reduction_a_conv_3x3_2_bn,  n.reduction_a_conv_3x3_2_relu, \
        n.reduction_a_conv_3x3_3, n.reduction_a_conv_3x3_3_bn,  n.reduction_a_conv_3x3_3_relu, n.reduction_a_pool, n.reduction_a_concat = \
        ...
        # reduction_v4_b
        n.reduction_b_1x1_reduce, n.reduction_b_pool, n.reduction_b_3x3_reduce, n.reduction_b_3x3_reduce_bn,  n.reduction_b_3x3_reduce_relu, n.reduction_b_3x3, \
           n.reduction_b_3x3_bn,  n.reduction_b_3x3_relu, \
           n.reduction_b_3x3_reduce_1, n.reduction_b_3x3_reduce_1_bn,  n.reduction_b_3x3_reduce_1_relu, \
           n.reduction_b_3x3_1, n.reduction_b_3x3_1_bn,  n.reduction_b_3x3_1_relu, \
           n.reduction_b_3x3_reduce_2, n.reduction_b_3x3_reduce_2_bn,  n.reduction_b_3x3_reduce_2_relu, \
           n.reduction_b_3x3_2, n.reduction_b_3x3_2_bn,  n.reduction_b_3x3_2_relu, \
           n.reduction_b_3x3_2a, n.reduction_b_3x3_2a_bn,  n.reduction_b_3x3_2a_relu, n.reduction_b_concat = \
        ...
        n.Block8_conv_1x1, n.Block8_conv_1x1_bn,  n.Block8_conv_1x1_relu, n.Block8_conv_1x1_2, \
        n.Block8_conv_1x1_2_bn,  n.Block8_conv_1x1_2_relu, n.Block8_conv_1x3_2, \
        n.Block8_conv_1x3_2_bn,  n.Block8_conv_1x3_2_relu, n.Block8_conv_3x1_2, n.Block8_conv_3x1_2_bn,  \
